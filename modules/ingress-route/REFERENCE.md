...
|------|-------------|------|---------|:--------:|
| <a name="input_metadata"></a> [metadata](#input\_metadata) | Traefik ingress route metadata | <pre>object({<br>    name      = string<br>    namespace = optional(string, "default")<br>  })</pre> | n/a | yes |
