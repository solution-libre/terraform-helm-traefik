...
- Proxy Protocol trustedIPs with `ingress_routes_tcp`

### Fixed

- Double entrypoint args for `ingress_routes_tcp`

## [0.17.2] - 2026-01-12

### Added

- `spec.tls.secret_name` attribute of input variable `ingress_routes_tcp`
...
- It is now possible to define multiple hostnames and their associated paths and/or prefixed paths in `match` attribute
of `ingress_routes` input variable
...
- Rename in3put variable `ingress` to `ingress_routes`
...
[0.17.3]: https://usine.solution-libre.fr/french-high-availability-multi-cloud-hosting/terraform-modules/traefik/-/compare/v0.17.2...v0.17.3
[0.17.2]: https://usine.solution-libre.fr/french-high-availability-multi-cloud-hosting/terraform-modules/traefik/-/compare/v0.17.1...v0.17.2
